...
<!--                  <el-button slot="prepend" icon="el-icon-user" @click="findData"></el-button>-->
              ...
              <el-form-item label="" prop="olderPassword" >
                <el-input  type="password" prefix-icon="el-icon-s-goods"  placeholder="请输入密码" style="width: 70%;" v-model="ruleForm.olderPassword" required></el-input>
              </el-form-item>
              <el-form-item>
                <el-row>
                  <el-col :span="10">
            ...
            <div v-if="active===1">
              ...
              <el-form-item label="年龄" prop="olderAge" >
                <el-input v-model="ruleForm.olderAge"   placeholder="请输入年龄"  type="number"></el-input>
              </el-form-item>
              <el-form-item label="手机号" prop="olderPhone" >
                <el-input v-model="ruleForm.olderPhone"   placeholder="请输入手机号" ></el-input>
              </el-form-item>
              <el-form-item label="身份证" prop="olderCard" >
                <el-input v-model="ruleForm.olderCard"   placeholder="请输入身份证号" ></el-input>
              </el-form-item>
              <el-form-item>
                <el-row>
                  <el-col :span="8">
