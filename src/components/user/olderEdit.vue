  ...
  <div style="margin-top: 15px;">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" >
        <el-form-item label="姓名" prop="olderName" >
            <el-input v-model="ruleForm.olderName"  placeholder="请输入姓名" style="width:50%"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="olderPassword" >
            <el-input  type="password" :autosize="{ minRows: 5, maxRows: 10}" style="width:50%"  placeholder="请输入密码" v-model="ruleForm.olderPassword" ></el-input>
        </el-form-item>
        ...
        <el-form-item label="年龄" prop="olderAge" >
          <el-input v-model="ruleForm.olderAge"   placeholder="请输入年龄" style="width:50%" type="number"></el-input>
        </el-form-item>
        <el-form-item label="手机号" prop="olderPhone" >
            <el-input v-model="ruleForm.olderPhone"   placeholder="请输入手机号" style="width:50%"></el-input>
        </el-form-item>
        <el-form-item label="身份证" prop="olderCard" >
          <el-input v-model="ruleForm.olderCard"   placeholder="请输入身份证号" style="width:50%"></el-input>
        </el-form-item>
